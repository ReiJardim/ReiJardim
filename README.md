...
- 🤖 Explorando IA/ML com foco em aplicações práticas
- 🌍 Especialista em Geoprocessamento e análises espaciais
- 💧 Trabalho com Dam Break (ruptura de barragens) e análises hidráulicas
- 🎨 Modelagem 3D com Blender e FreeCAD
- 📊 Criando aplicações web com Django e Streamlit
...
<div align="center">
  ...
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=ReiJardim&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&hide_border=true&bg_color=0d1117&title_color=FFD700&icon_color=FFD700&text_color=c9d1d9&ring_color=FFD700"/>

  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=ReiJardim&layout=compact&langs_count=8&hide_border=true&bg_color=0d1117&title_color=FFD700&text_color=c9d1d9"/>

</div>

<div align="center">

  [![GitHub Streak](https://github-readme-streak-stats.herokuapp.com?user=ReiJardim&theme=dark&hide_border=true&background=0D1117&ring=FFD700&fire=FFD700&currStreakLabel=FFD700&sideLabels=c9d1d9&dates=c9d1d9&currStreakNum=FFD700&sideNums=c9d1d9)](https://git.io/streak-stats)
...
```python
interesses = {
    "Engenharia Civil": ["Dam Break", "Hidráulica", "Acompanhamento de  obra"],
    "Geoprocessamento": ["QGIS", "ArcGIS", "Análise Espacial", "Sensoriamento Remoto"],
    "Modelagem 3D": ["Blender", "FreeCAD", "Automação CAD"],
    "Programação": ["Python", "Web Development", "APIs"],
    "IA & ML": ["NLP", "RAG", "Processamento de Áudio", "LLMs"],
    "Dados": ["Análise de Dados", "Visualização", "Streamlit"]
}
```
